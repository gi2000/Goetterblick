...
public interface ConstStartModule
{
    ...
    String BUTTON_MODULE_DEFAULT_ICON = "bi-slash-square";
    ...
    String CSS_BIG_MODULES_FONT_ICON = "big-module-icon";
    String CSS_MODULES_FONT_ICON     = "module-icon";
    ...
    Tuple<String, Integer>    FXML_START_AMT_VERSIONS_PER_ROW = new Tuple<>(
            Utils.joinSegms(SEGM_START, SEGM_VERSIONS, "amount-per-row"), 4);
    @DefaultCfgValue
